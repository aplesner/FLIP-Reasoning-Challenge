...
params_file_path="${data_dir}/exp0/params_reason_0.json"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file
flip_challenges_dir="${data_dir}/sub_long_train_split_2_tasks"
images_dir="${data_dir}/sub_long_train_split_2_images"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file
...
caption_file_paths="${exp_dir}/sub_long_train_split_2_tasks__BLIP2_flan_t5_xxl.json"

...
flip_challenges_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/full_flips_set/sub_long_train_split_2/tasks"
images_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/full_flips_set/sub_long_train_split_2/images"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file

reasoning_models="Gemini_1_5_pro_002_context_16"
# one or multiple model (separated by comma & no space in between) \
...
# caption_file_paths=""
caption_file_paths="/mnt/c/ETH/Thesis/flip-slim/data/exp4/sub_long_train_split_2__BLIP2_flan_t5_xxl.json"

...
flip_challenges_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/full_flips_set/sub_long_train_flips_set/sub_long_train_flips_set_tasks"
images_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/full_flips_set/sub_long_train_flips_set/sub_long_train_flips_set_images"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file

reasoning_models="ChatGPT_4_turbo"
# one or multiple model (separated by comma & no space in between) \
...
# caption_file_paths=""
caption_file_paths="${exp_dir}/sub_long_train_flips_set_images__BLIP2_flan_t5_xxl.json"

...
reasoning_models="Gemini_1_5_pro_002_Qwen_context_100"
# one or multiple model (separated by comma & no space in between) \
...
# caption_file_paths=""
caption_file_paths="/mnt/c/ETH/Thesis/flip-slim/data/exp0/full_val_split_images__BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"
...
context_dir="/mnt/c/ETH/Thesis/flip-slim/src/built_contexts/exp_4"

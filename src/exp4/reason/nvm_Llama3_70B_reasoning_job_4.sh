...
caption_models="ViPLlava_7B,ViPLlava_13B,LlavaNeXT_mistral_7B,LlavaNeXT_vicuna_7B,LlavaNeXT_vicuna_13B,BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl,Llama_3_2_11B,Phi_3_5"
...
caption_file_paths="${exp_dir}/full_val_split_images__ViPLlava_7B.json"
...
output_file_name="test_batched_${reasoning_models}__${caption_models}.json"
...
apptainer exec --nv --bind "/scratch/$USER:/scratch/$USER" \
--env LC_ALL=C,USER=$USER_NAME,TMPDIR=$TMPDIR,PYTHONUSERBASE=$PYTHONUSERBASE,PYTHONNOUSERSITE=$PYTHONNOUSERSITE,PIP_CACHE_DIR=$PIP_CACHE_DIR,PYTHONPATH=$PYTHONPATH,JUPYTER_DATA_DIR=$JUPYTER_DATA_DIR,HF_HOME=$HF_HOME,TRANSFORMERS_CACHE=$TRANSFORMERS_CACHE,HUGGINGFACE_HUB_CACHE=$HUGGINGFACE_HUB_CACHE,TORCH_HOME=$TORCH_HOME \
/scratch/$USER/cuda_sandbox /scratch/$USER/apptainer_env/venv/bin/python -m pip install wandb

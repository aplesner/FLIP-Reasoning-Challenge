...
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file
# NVLM_72B ~ 152_945 MiB at bfloat16
reasoning_models="NVLM_72B"
# one or multiple model (separated by comma & no space in between) \
...
output_file_name="${reasoning_models}__${caption_models}_test.json"
...
flip_container_v3.sif python3 $filepath \

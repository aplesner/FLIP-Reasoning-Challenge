...
caption_models="LlavaNeXT_vicuna_7B,LlavaNeXT_mistral_7B,LlavaNeXT_vicuna_13B"
...
/scratch/$USER/cuda_sandbox /scratch/$USER/apptainer_env/venv/bin/python -m pip install google protobuf

...
# Phi_3_5 ~ 12_152MiB at bfloat16

# all together ~130GB ! ACCOUNT FOR PROCESSING VRAM AS WELL ! need about 5-10GB free room!

caption_models="LlavaNeXT_vicuna_13B,LlavaNeXT_mistral_7B,ViPLlava_7B,LlavaNeXT_vicuna_13B,ViPLlava_13B,Llama_3_2_11B"

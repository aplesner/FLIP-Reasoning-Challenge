...
params_file_path="${exp_dir}/params_reason_1.json"
...
reasoning_models="Qwen_2_5_8bit"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file (and caption_file_paths)
caption_models="BLIP2_flan_t5_xxl_0_1t,BLIP2_flan_t5_xxl_0_825t,BLIP2_flan_t5_xxl_1_55t,BLIP2_flan_t5_xxl_2_275t,BLIP2_flan_t5_xxl_3_0t"
...
caption_file_paths="${exp_dir}/full_val_split_images__BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__BLIP2_2_7B,BLIP2_6_7B_COCO,BLIP2_flan_t5_xxl.json"

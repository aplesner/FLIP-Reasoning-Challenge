...
flip_split="full_val_split_tasks"
...
caption_file_paths="${exp_dir}/UPDATED_full_val_split_images__ViPLlava_13B,ViPLlava_7B.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/UPDATED_full_val_split_images__ViPLlava_13B,ViPLlava_7B.json"
# caption_file_paths="${exp_dir}/full_val_split_images__ViPLlava_13B,ViPLlava_7B.json"
# caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__ViPLlava_13B,ViPLlava_7B.json"
# caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__BLIP2_flan_t5_xxl.json"
...
# caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images__Phi_3_5.json"

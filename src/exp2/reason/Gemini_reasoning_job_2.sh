...
caption_file_paths="${exp_dir}/full_val_split_images_Qwen_2_5_8bit__ViPLlava_7B,ViPLlava_13B,BLIP2_flan_t5_xxl_SUMMARY.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images_Qwen_2_5_8bit__ViPLlava_7B,ViPLlava_13B,BLIP2_flan_t5_xxl_SUMMARY.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images_nvm_Llama3_51B__ViPLlava_7B,ViPLlava_13B_SUMMARY.json"
caption_file_paths="${caption_file_paths}::${exp_dir}/full_val_split_images_nvm_Llama3_51B__BLIP2_flan_t5_xxl_SUMMARY.json"

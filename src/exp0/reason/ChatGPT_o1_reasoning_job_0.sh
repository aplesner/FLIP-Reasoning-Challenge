...
flip_challenges_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/short_flips_set_val_flips"
images_dir="/mnt/c/ETH/Thesis/image-captchas/Flip/data/short_images_of_valid_flips"
# one or multiple model (separated by comma & no space in between) \
# names as defined in the params_file

reasoning_models="ChatGPT_o1_preview"
# one or multiple model (separated by comma & no space in between) \
...
caption_file_paths="${exp_dir}/short_images_of_valid_flips__BLIP2_flan_t5_xxl.json"

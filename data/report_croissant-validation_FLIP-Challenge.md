...
```json
{
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://huggingface.co/datasets/aplesner-eth/FLIP-Challenge/tree/refs%2Fconvert%2Fparquet",
  ...
  "recordSet": [
    ...
    },
    {
      "@type": "cr:RecordSet",
      "@id": "default",
      "description": "aplesner-eth/FLIP-Challenge - 'default' subset\n\nAdditional information:\n- 3 splits: train, validation, test",
      "field": [
        {
          "@type": "cr:Field",
          "@id": "default/split",
  ...
  "creator": {
    ...
    "url": "https://huggingface.co/aplesner-eth"
  },
  "keywords": [
    "English",
    "arxiv:2504.12256",
  ...
  "url": "https://huggingface.co/datasets/aplesner-eth/FLIP-Challenge"
}
```